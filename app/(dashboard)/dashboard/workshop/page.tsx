...
export default function WebinarList() {
    ...
    const fetchWebinars = async () => {
      try {
        const res = await apiRequest<null, any>({
          endpoint: '/api/webinars/live-workshops/active',
          method: 'GET',
        })
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      toast.success('You have successfully registered for this workshop 🎉')
  ...
  return (
    <div className="p-6">
      {/* HEADER */}
      <div className="mb-6">
        <h1 className="text-2xl font-semibold text-[#252641]">Live Workshops</h1>
