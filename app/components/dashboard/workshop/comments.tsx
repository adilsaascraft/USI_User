  ...
  const [comments, setComments] = useState<Comment[]>([
    {
      id: 1,
      name: "Jane Doe",
      text: "Really enjoyed this workshop! The speakers explained everything clearly.",
    },
    {
      id: 2,
      name: "Kevin Peterson",
      text: "Great learning workshop, very interactive and well-organized.",
    },
  ]);
    ...
    <div className="bg-white p-4 rounded-xl shadow-sm mb-6">
      ...
      >
        <div className="flex items-start gap-3">
          ...
          <textarea
            ...
            placeholder="Write your comment about the workshop..."
      ...
      <div className="mt-6">
        <h2 className="font-semibold text-lg mb-4">
          Workshop Comments ({comments.length})
        </h2>
