...
import { addToMyPrograms } from "@/lib/myProgramStorage";
...
export default function PurchaseForm({
  ...
  function handlePay(e: React.FormEvent) {
    ...
    setTimeout(() => {
      // ✅ ADD TO MY PROGRAMS
      addToMyPrograms(Number(programId));

      setLoading(false);
      alert(`Payment successful! Program unlocked. Amount: ₹${price}`);
