 ...
 * - programId: optional program id to load config from feedbackByProgram
 *
 * Prefer passing cfg from the page:
 * <ProgramFeedback cfg={feedbackByProgram[id]} />
 */
export default function ProgramFeedback({
  ...
  // load config either from prop or from data file using programId
  const cfgFromId = programId
    ? feedbackByProgram[programId]
    : undefined;
  ...
  function onSubmit() {
    ...
    setTimeout(() => {
      ...
      console.log("Program feedback payload:", payload);
      ...
      <div className="space-y-6">
        {questions.length > 0 ? (
          ...
          <div className="text-gray-600">
            No feedback questions available for this program.
          </div>
        )}
      </div>
