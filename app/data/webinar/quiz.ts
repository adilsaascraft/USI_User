...
// questions per webinar
export const quizByWebinar: Record<number, QuizQuestion[]> = {
  1: [
    {
      id: "q1",
      q: "Which organ is primarily discussed in the Renal Transplantation webinar?",
    ...
    },
    {
      ...
      options: ["Cardiologist", "Transplant Surgeon", "Dermatologist", "Pulmonologist"],
      answerIndex: 1,
    },
    {
      id: "q3",
    ...
    },
    {
      ...
      options: ["Cosmetic improvement", "Restore organ function", "Weight loss", "Pain relief"],
      answerIndex: 1,
    },
    {
      id: "q5",
      q: "Which laboratory test monitors kidney function after transplant?",
      options: ["HbA1c", "Serum creatinine", "LFTs", "Lipid profile"],
      answerIndex: 1,
    },
    {
      id: "q6",
      ...
      options: [
        "Time the organ is warm outside body",
        "Time organ is preserved on ice before transplant",
        "Operation duration",
    ...
    },
    {
      ...
      options: ["Chest X-ray", "CT angiography", "Brain MRI", "DEXA scan"],
      answerIndex: 1,
    },
    {
      id: "q8",
      q: "A common early post-transplant complication is:",
      options: ["Graft rejection", "Diabetes mellitus type 2", "Chronic arthritis", "Myopia"],
      answerIndex: 0,
    },
    {
      id: "q9",
  ...
  2: [], // add questions for other webinars as needed
  3: [],
  4: [],
  5: [],
};

// per-webinar quiz settings (metadata)
export const quizMetaByWebinar: Record<number, { perQuestionSeconds?: number; durationMinutes?: number }> = {
  1: { perQuestionSeconds: 30 }, // 30 seconds per question for webinar 1
