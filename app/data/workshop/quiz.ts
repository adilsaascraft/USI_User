...
/* ================= QUESTIONS PER WORKSHOP ================= */
export const quizByWorkshop: Record<number, QuizQuestion[]> = {
  1: [
    {
      id: "q1",
      q: "Which organ is primarily discussed in the Renal Transplantation workshop?",
...
/* ================= QUIZ META PER WORKSHOP ================= */
export const quizMetaByWorkshop: Record<
  number,
  {
